<html>
	...
	<body id="corpo" class="w3-margin">
		...
		<fildset id="ListaRepositorios" class="w3-small" style="display:block;">
			<table class="w3-small w3-margin-top">
				<thead id="header">
				<tr>
					<th>Nome</th>
					<th>Descrição</th>
				...
				<div id="navigate" class="w3-center">
					<a   id="preview"     class="nav" href="javascript://"><<</a>
					<h4  id="currentPage" class="nav" href="javascript://">1</h4>
					<a   id="next"        class="nav" href="javascript://">>></a>
				</div>
		</fildset>	
	</body>	
</html>
...
<script>
	...
	$("a#preview, a#next, #enviar, a.sort").bind('click', function(e){
		...
		//SORT+ORDER
		if ( e['currentTarget']['className'] == 'sort') {
			e.preventDefault();			
			sort  = e['currentTarget']['attributes']['sort']['value']
			order = e['currentTarget']['attributes']['order']['value'];			
		}	
